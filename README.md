...
- Saisie du mot : Afficher lettres sur la première ligne lors de la saisie sur clavier physique/virtuel (==> Julien)
- Générateur : Générateur de mots de 5 lettres / Mot du jour : Un même mot pour tous les joueurs par jour (même mot pendant 24h, basé sur la date du jour) (==> Simon)
- Grille de jeu : Compteur qui affiche les tentatives (==> Jérôme)
...
- S'occuper des bordures internes au niveau des .cell
